...
[(0, 1), (0, 4), (0, 2), (0, 7), (0, 5), (0, 6), (0, 3), (0, 8), (1, 4), (1, 8), (4, 2), (2, 7), (7, 5), (5, 6), (6, 3), (3, 8)],
[(0, 4), (0, 2), (0, 3), (0, 8), (0, 5), (0, 6), (0, 7), (0, 1), (4, 2), (4, 1), (2, 3), (3, 8), (8, 5), (5, 6), (6, 7), (7, 1)],
[(0, 1), (0, 5), (0, 8), (0, 4), (0, 3), (0, 6), (0, 7), (0, 2), (1, 5), (1, 2), (5, 8), (8, 4), (4, 3), (3, 6), (6, 7), (7, 2)],
[(0, 1), (0, 2), (0, 4), (0, 6), (0, 5), (0, 3), (0, 7), (0, 8), (1, 2), (1, 8), (2, 4), (4, 6), (6, 5), (5, 3), (3, 7), (7, 8)],
[(4, 1), (4, 6), (4, 3), (4, 2), (4, 5), (4, 8), (4, 7), (4, 0), (1, 6), (1, 0), (6, 3), (3, 2), (2, 5), (5, 8), (8, 7), (7, 0)],
[(0, 1), (0, 2), (0, 5), (0, 3), (0, 7), (0, 6), (0, 4), (0, 8), (1, 2), (1, 8), (2, 5), (5, 3), (3, 7), (7, 6), (6, 4), (4, 8)],
[(0, 7), (0, 4), (1, 3), (1, 8), (2, 6), (3, 4), (4, 5), (6, 7), (7, 8)],
[(0, 7), (0, 4), (2, 1), (2, 8), (3, 6), (1, 4), (4, 5), (6, 7), (7, 8)],
[(0, 7), (0, 3), (1, 8), (1, 2), (4, 6), (8, 3), (3, 5), (6, 7), (7, 2)],
[(2, 0), (2, 5), (1, 3), (1, 8), (4, 6), (3, 5), (5, 7), (6, 0), (0, 8)],
[(5, 7), (5, 4), (3, 0), (3, 8), (2, 6), (0, 4), (4, 1), (6, 7), (7, 8)],
[(0, 6), (0, 4), (1, 3), (1, 7), (8, 2), (3, 4), (4, 5), (2, 6), (6, 7)],
[(5, 7), (5, 4), (1, 3), (1, 8), (0, 6), (3, 4), (4, 2), (6, 7), (7, 8)],
[(0, 7), (0, 8), (5, 3), (5, 1), (2, 6), (3, 8), (8, 4), (6, 7), (7, 1)]
]

graph_type = 'Wheel_Watts'
...
for i in range(1):
    for j in range(len(graphs)):
        for k in range(len(graphs)):
            ...
            # weights_init = np.random.randn(2*int(np.sqrt(n_nodes)), n_nodes, requires_grad=True)
            angle = [weights_init]
    ...
    # ### circuit results in tensor array size 2^9, but only need value at position 0 
            ...
            with open ('../Data/QGK_' + graph_type + '_List_Angles_Graphs_' + str(j) + '_' + str(k) + '.csv', 'a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow(angle)  
                file.close() 

            with open ('../Data/QGK_' + graph_type + '_List_Cost_Graphs_' + str(j) + '_' + str(k) + '.csv', 'a', newline='') as file:
                writer = csv.writer(file)
...
for i in range(1):
    ...
    ### circuit results in tensor array size 2^9, but only need value at position 0 
            ...
            with open ('../Data/QGK_' + graph_type + '_Sandwich_Angles_Graphs_' + str(j) + '_' + str(k) + '.csv', 'a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow(angle)  
                file.close() 

            with open ('../Data/QGK_' + graph_type + '_Sandwich_Cost_Graphs_' + str(j) + '_' + str(k) + '.csv', 'a', newline='') as file:
                writer = csv.writer(file)
